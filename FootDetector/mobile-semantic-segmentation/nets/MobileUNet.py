...
from keras.layers import BatchNormalization, Activation, Conv2D, concatenate, Conv2DTranspose, DepthwiseConv2D, ReLU
...
def _conv_block(inputs, filters, alpha, kernel=(3, 3), strides=(1, 1), block_id=1):
    ...
    return ReLU(6., name='conv_%d_relu' % block_id)(x)
